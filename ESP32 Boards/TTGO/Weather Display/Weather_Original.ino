...
const char* password = "6RGUAHGP"; //EDI8IT
String town="London";              //EDDIT
String Country="GB";                //EDDIT
const String endpoint = "http://api.openweathermap.org/data/2.5/weather?q="+town+","+Country+"&units=metric&APPID=";
const String key = "aaa7a98826c128b9a1c28fd1cb162b61"; /*EDDITTTTTTTTTTTTTTTTTTTTTTTT                      */
...
void loop() {
  ...
  //formattedDate = "22/12/2022"; //timeClient.getFormattedDate();
